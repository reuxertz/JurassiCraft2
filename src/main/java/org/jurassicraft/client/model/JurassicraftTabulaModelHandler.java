...
public enum JurassicraftTabulaModelHandler implements ICustomModelLoader, JsonDeserializationContext {
    ...
    public IModel loadModel(ResourceLocation modelLocation) throws IOException {
        ...
        return new JurassicraftVanillaTabulaModel(modelJson, particle != null ? new ResourceLocation(particle) : null, builder.build(), IPerspectiveAwareModel.MapWrapper.getTransforms(modelBlock.getAllTransforms()));
    }
