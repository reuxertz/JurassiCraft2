...
public class BrachiosaurusAnimator extends EntityAnimator<BrachiosaurusEntity> {
    ...
    protected void performAnimations(AnimatableModel model, BrachiosaurusEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale) {
        ...
        AdvancedModelRenderer[] neckParts = new AdvancedModelRenderer[] { head, neck10, neck9, neck8, neck7, neck6, neck5, neck4, neck3, neck2, neck1 };
        AdvancedModelRenderer[] tailParts = new AdvancedModelRenderer[] { tail6, tail5, tail4, tail3 };
        AdvancedModelRenderer[] tailParts2 = new AdvancedModelRenderer[] { tail6, tail5, tail4, tail3, tail2, tail1 };
        float delta = Minecraft.getMinecraft().getRenderPartialTicks();
        AdvancedModelRenderer root = model.getCube("bodyHips");
        AdvancedModelRenderer backLeftThigh = model.getCube("thighLeft");
        AdvancedModelRenderer backLeftCalf = model.getCube("calfLeft");
        AdvancedModelRenderer backRightThigh = model.getCube("thighRight");
        AdvancedModelRenderer backRightCalf = model.getCube("calfRight");
        AdvancedModelRenderer frontLeftThigh = model.getCube("bicepLeft");
        AdvancedModelRenderer frontLeftCalf = model.getCube("forearmLeft");
        AdvancedModelRenderer frontRightThigh = model.getCube("bicepRight");
        AdvancedModelRenderer frontRightCalf = model.getCube("forearmRight");
