...
//        registerBlock(JP_MAIN_GATE_BLOCK, "Jurassic Park Gate");
        ...
        registerBlock(ElectricFenceWireBlockEntity.class, "tileEntityElectricFence", LOW_SECURITY_FENCE_WIRE, "Security Fence Wire");
...
//        registerBlock(HIGH_SECURITY_FENCE_WIRE, "High Security Fence Wire");
        ...
        registerBlock(ElectricFencePoleBlockEntity.class, "tileEntityElectricPole", LOW_SECURITY_FENCE_POLE, "Security Fence Pole");
...
//        registerBlock(HIGH_SECURITY_FENCE_POLE, "High Security Fence Pole");
        ...
        registerBlock(ElectricFenceBaseBlockEntity.class, "tileEntityElectricBase", LOW_SECURITY_FENCE_BASE, "Security Fence Base");
