...
public class MicroraptorEntity extends DinosaurEntity {
    ...
    @Override
    public void moveEntityWithHeading(float strafe, float vertical) {
	float prevRot = this.rotationPitch;
        ...
        super.moveEntityWithHeading(strafe, vertical);
	...
	for(BlockPos pos : BlockPos.getAllInBox(new BlockPos(MathHelper.floor(this.posX - radiusXZ), MathHelper.floor(this.posY), MathHelper.floor(this.posZ - radiusXZ)), new BlockPos(MathHelper.ceil(this.posX + radiusXZ), MathHelper.ceil(this.posY), MathHelper.ceil(this.posZ + radiusXZ)))) {
