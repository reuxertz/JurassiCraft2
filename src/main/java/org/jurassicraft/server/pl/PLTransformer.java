package org.jurassicraft.server.pl;
...
public class PLTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        onEntityCollidedWithBlock.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "org/jurassicraft/server/pl/PLTransformer", "onEntityCollidedWithLeaves", "(Lnet/minecraft/entity/Entity;)V", false));
    ...
    public static void onEntityCollidedWithLeaves(Entity entity) {
        entity.motionX *= Double.valueOf(.75D);
        entity.motionY *= Double.valueOf(.75D);
        entity.motionZ *= Double.valueOf(.75D);
        entity.fallDistance = Float.valueOf(0f);
    }
